...
const db = require('quick.db')
    ...
    exports.run = (client, message, args) => {
        ...
        if(!args[0]){
            ...
            .setDescription(`**Küfür Engel Sistemini Açabilmek & Kapatabilmek İçin \`m+küfür-engel aç\`, \`m+küfür-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'aç'){
            ...
            .setDescription(`**Küfür Engel Sistemini Başarılı Bir Şekilde Açtınız. Eğer Kapatmak İstersenizde** \`m+küfür-engel kapat\``)
            .setColor('#36393F')
        ...
        if(args[0] === 'kapat'){
            ...
            .setAuthor(`${message.author.username} - Başarılı`, message.author.avatarURL({dynamic: true}))
            .setDescription(`**Küfür Engel Sistemini Başarılı Bir Şekilde Kapattınız. Eğer Açmak İstersenizde** \`m+küfür-engel aç\``)
            .setColor('#36393F')
