...
exports.run = async (client, message, args) => {
  if(!message.member.voice.channel) return message.reply('<a:slk:830538658741747742> | Sese girer misin?')
if(!args[0]) return message.reply('<a:slk:830538658741747742> | Değer gir')
if(args[0] == 'yt') {
