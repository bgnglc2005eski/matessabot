...
let prefix = ayarlar.prefix
   if(!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('<a:bidiribidiri:810223381819162694> Bu komutu kullanabilmek için `Sunucuyu yönet` yetkisine sahip olmalıısn')
